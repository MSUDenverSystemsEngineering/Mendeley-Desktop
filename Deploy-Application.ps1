...
Try {
	...
	[string]$appVendor = 'Elsevier'
	[string]$appName = 'Mendeley Desktop'
	[string]$appVersion = '1.19.8'
	[string]$appArch = 'x86'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.1'
	[string]$appScriptDate = '08/03/2022'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Show-InstallationWelcome -CloseApps 'mendeleydesktop' -CheckDiskSpace -PersistPrompt

		## Show Progress Message (with the default message)
		Show-InstallationProgress

		## <Perform Pre-Installation tasks here>
		If (Test-Path "$envProgramFilesX86\Mendeley Desktop\Uninstaller.exe") {
			$exitCode = Execute-Process -Path "$envProgramFilesX86\Mendeley Desktop\Uninstaller.exe" -Parameters '/S' -WindowStyle 'Hidden'
			...
			While($uninstallerExists){
				...
				Else {
					...
					Write-Log -Message "Uninstaller.exe no longer detected. Continuing..." -Source 'Pre-Installation' -LogType 'CMTrace'
				}
			}
		}
		...
		$exitCode = Execute-Process -Path "$dirFiles\Mendeley-Desktop-1.19.8-win32.exe" -Parameters '/S' -WindowStyle 'Hidden' -IgnoreExitCodes '1223' -PassThru
		...
		If (Test-Path "$env:Public\Desktop\Mendeley Desktop.lnk") {
			Remove-Item "$env:Public\Desktop\Mendeley Desktop.lnk" -Force
		}
		Else {
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'mendeleydesktop' -CloseAppsCountdown 60
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUhBXibwNYIh/Luu2U6hVtjwvt
# RoGgghHXMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# MRYEFAD24NiralxFctfN8zAu8i2o/wzfMA0GCSqGSIb3DQEBAQUABIIBgE8YSAIr
# Up6YXFYkXOJbkIn5FjTnx5oj0KjWLnN9VXATlQE6r/emzNs2za/j1ZafnmLke6Ft
# SssV3XO2iXOF1eQTgseYD+YJDFvS6pkMkgKEhj/tlbmHwi0gJcGW0NE33SXTuqRD
# JDQmxFm+dd5Dir/n3ZkG5KTPRV9RBDMFrDDMVWwdGEDpxCmzhhK7+C8Uv5Dd7q44
# SXfGg4Z3lu9543NivQ4L8gxN9VOyPu498KtJreIeiHK6lnICiSJxeRlnUzFMzTNL
# TYZ27ClBURbBDvoRpLukZyLj6TAukc+K1LSAZ1rcgsPVzwQHhAnSU4/qdwfNhWq5
# IphdyNT9+2FLSl4qYPEvOMiSutfoAhMUANHePi7TugZJgUjAtNAopgNmKUpORsF0
# p/ALBnBaK3WtYyRVCP9RYUm4Jnbefk5VTq0ozlKtb24zE7c470KJBxWsVoxe7JTw
# tuW5AR3uLkXeNaIdS8RtY/PxeIeK21QXPUf0w3C//iV1TVMt88XMgzaozg==
