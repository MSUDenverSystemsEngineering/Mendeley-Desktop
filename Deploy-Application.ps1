...
Try {
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Show-InstallationWelcome -CloseApps 'Mendeley Reference Manager' -CheckDiskSpace -PersistPrompt
		...
		If (Test-Path "$env:Public\Desktop\Mendeley Reference Manager.lnk") {
			Remove-Item "$env:Public\Desktop\Mendeley Reference Manager.lnk" -Force
		}
		Else {
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'Mendeley Reference Manager' -CloseAppsCountdown 60
